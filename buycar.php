...
$sql ="insert into buycars(purchaseid,carid,custid ,purchasedate,deliverydate,comments,paid,paymenttype,address,city,zipcode) values('$_POST[purid]','$_POST[vehid]','$_POST[custid]','$_POST[purdate]','$_POST[deldate]','$_POST[comments]','$_POST[advance]','$_POST[payment]','$_POST[address]','$_POST[city]','$_POST[zipcode]')";
