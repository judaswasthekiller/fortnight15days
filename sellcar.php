...
$sql ="insert into car(custid,vehname,model,brand,images,estmdprice,otherinfo,status) values('$_SESSION[custid]','$_POST[vehname]','$_POST[model]','$_POST[brand]','$img','$_POST[estdprice]','$_POST[other]','Pending')";
...
if($img != "")
{
$sql ="update car set custid='$_SESSION[custid]',vehname='$_POST[vehname]',model='$_POST[model]',brand='$_POST[brand]',images='$img',estmdprice='$_POST[estdprice]',otherinfo='$_POST[other]' where sellno='$_GET[updtid]'";
}
else
{
$sql ="update car set custid='$_SESSION[custid]',vehname='$_POST[vehname]',model='$_POST[model]',brand='$_POST[brand]',estmdprice='$_POST[estdprice]',otherinfo='$_POST[other]' where sellno='$_GET[updtid]'";
}
	if (!mysql_query($sql,$con))
	  {
	  die('Error: ' . mysql_error());
	  ...
	  {
		  $recresult = "<font color='green'><b>car record updated successfully...</b></font>";
	  }
}
?>
<?php
...
{
$sql = mysql_query("select * from car where sellno='$_GET[updtid]'");
...
?>
		...
		<div id="main">				
			...
			{
				?>
<center><h3>cars record added successfully.. </center></h3>
          <?php
			}
	else
	{
		...
		<form action="" method="post" enctype="multipart/form-data" onsubmit="return validate()" name="form1" id="form1">		
			<table width="484" border="0">
			  <tr>
			    <th width="264" height="37" scope="row">car Name
			  ...
			  <tr>
				...
				{ 
				?>
                <input type="submit" name="update" id="update" value="Update car" /><?php }else{ ?><input type="submit" name="submit" id="submit" value="Sell car" /><?php } ?></td>
		      </tr>
          </table>
	<?php
    }
