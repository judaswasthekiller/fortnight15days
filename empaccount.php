...
?>
    ...
    <tr>
      <td height="42" align="center" valign="middle"><strong>Number of car service requests</strong></td>
...
?>
    ...
    <tr>
      <td height="33" align="center" valign="middle"><strong>Used cars</strong></td>
      <td align="center" valign="middle"><strong>
        <?php
            $sqlcount = mysql_query("select * from car where status ='Pending'");
			echo mysql_num_rows($sqlcount);
			?>
      </strong></td>
    </tr>
    <tr>
      <td height="40" align="center" valign="middle"><strong>No. of vehices in car store</strong></td>
      <td align="center" valign="middle">
	    <strong>
	    <?php
           $sqlcount = mysql_query("select * from carstore where status !='Sold'");
			echo mysql_num_rows($sqlcount);
			?>
      </strong></td>
    </tr>
