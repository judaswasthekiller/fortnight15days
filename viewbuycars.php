...
<form id="form1" name="form1" method="post" action="">
		  <table width="754" border="1">
		    <tr>
		      ...
		      <th width="103" scope="col">car Name</th>
		  ...
		  {  
$result1= mysql_query("select * from carstore where carid='$arrrec[carid]'");
...
$arrrec2= mysql_fetch_array($result2);
		   echo" <tr>
		      ...
		      <td><b>car ID:</b> $arrrec1[carid]<br>
			  <b>car Name:</b> $arrrec1[vehname]<br>
			  <b>car Model:</b> $arrrec1[model]</td>
			 ...
			 if(isset($_SESSION[empid]))
			 {
			  if($arrrec[paymenttype]=="Pending")
			  {
				   ...
				   echo "<br><a href='viewbuycars.php?purchaseid=$arrrec[purchaseid]'><strong>Paid</strong></a>";
			  }
			 }
			 echo " </td>
	        </tr>";
