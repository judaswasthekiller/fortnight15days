...
$result3 = mysql_query("SELECT * FROM car where custid='$_SESSION[custid]' AND status='Accepted' ");

$result4 = mysql_query("SELECT * FROM car where custid='$_SESSION[custid]' AND status='Pending' ");
...
$result5 = mysql_query("SELECT * FROM booking where custid='$_SESSION[custid]' ");
        ...
        <table width="476" height="213" border="0">
          ...
          <tr bgcolor="#FFFFCC">
            <th height="59" scope="row"><u>car service status:</u></th>
            <td>&nbsp; <?php echo mysql_num_rows($result2) ;?> cars status Pending.<br />
        &nbsp; <?php echo mysql_num_rows($result1) ;?> cars status Completed. </td>
          </tr>
          <tr bgcolor="#CCCCCC">
            <th scope="row" ><u>car sell request:</u></th>
            <td>&nbsp; Sold :<?php echo mysql_num_rows($result3) ;?> cars <br />&nbsp; Pending :<?php echo mysql_num_rows($result4) ;?> cars</td>
          </tr>
          <tr bgcolor="#FFFFCC">
            <th scope="row"><u>No. of cars purchased:</u></th>
