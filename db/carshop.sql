...
alter table carshop.billing ADD foreign key(serviceid) REFERENCES carshop.service(serviecid);
alter table carshop.service ADD foreign key(custid) REFERENCES carshop.customer(custid);
alter table carshop.testdrive ADD foreign key(custid) REFERENCES carshop.customer(custid);
alter table carshop.booking ADD foreign key(custid) REFERENCES carshop.customer(custid);
alter table carshop.car ADD foreign key(custid) REFERENCES carshop.customer(custid);
alter table carshop.sparepartsorder ADD foreign key(custid) REFERENCES carshop.customer(custid);


alter table carshop.testdrive ADD foreign key(carid) REFERENCES carshop.carstore(carid);
alter table carshop.booking ADD foreign key(carid) REFERENCES carshop.carstore(carid);

alter table carshop.sparepartsorder ADD foreign key(spid) REFERENCES carshop.spareparts(spid);

alter table carshop.carstore ADD foreign key(empid) REFERENCES carshop.employee(employeeid);
...
INSERT INTO `carstore` (`carid`, `empid`, `vehname`, `model`, `brand`, `images`, `estprice`, `description`, `status`) VALUES
