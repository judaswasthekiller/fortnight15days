...
?>
		...
		<form id="form1" name="form1" method="post" action="">
		  <table width="686" border="1">
		    <tr>
		     <th width="169" scope="col">car info</th>
		  ...
		  {  
		   echo" <tr>
		      <td>&nbsp;
			  car name: $arrrec[carname]<br>
			  &nbsp; car No. $arrrec[carno]</td>
		      <td>&nbsp; $arrrec[date]</td>
		  ...
		  {  
		   echo" <tr>
			...
			City : $arrrec[city]</td>
              <td>&nbsp; $arrrec[status]</td>
			  <td>&nbsp; <a href='carservicebilling.php?serviceid=$arrrec[serviecid]'>View</a></td>
	        </tr>";
		  }
	      ?>
          </table>
