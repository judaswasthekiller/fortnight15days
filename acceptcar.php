...
$sql ="insert into carstore(empid,vehname,model,brand,images,estprice,description,status) values('$_SESSION[empid]','$_POST[vehname]','$_POST[model]','$_POST[brand]','$img','$_POST[estprice]','$_POST[description]','Pending')";
$ctins = 1;
if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
$sql1 = mysql_query("update car set status='Accepted' where sellno='$_GET[sellno]'");
}
...
{
$result = mysql_query("select * from car where sellno='$_GET[sellno]'");
...
if($ctins == 1)
{
	echo "<center><b>car Added to car store Successfully...</b></center><br>";
}
else
{	
?>					
