...
$arrrec1= mysql_fetch_array($result1);
		    ...
		    <tr>
		      ...
		      <th scope="col">&nbsp;<?php echo $row1[carname]; ?> </th>
	        </tr>
		    <tr>
		      <th scope="col">car No.</th>
		      <th scope="col">&nbsp;<?php echo $row1[carno]; ?> </th>
	        </tr>
		    <tr>
...
$arrrec1= mysql_fetch_array($result1);
		    ...
		    <tr>
		      <th height="37" colspan="2" scope="col"><input type="submit" name="btnpay" id="btnpay" value="Generate car service bill" /></th>
	        </tr>
		    <?php
		  while($arrrec= mysql_fetch_array($result))
		  {  
